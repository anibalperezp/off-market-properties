...
import 'package:zipcular/containers/widgets/floating_search_bar/floating_search_bar_scroll_notifier.dart';
...
class FloatingSearchBar extends ImplicitlyAnimatedWidget {
  ...
  final bool showVisibleFloatingFilter;
  final ValueChanged<bool> callbackFilters;
  final ValueChanged<bool> callbackDeal;
  final ValueChanged<bool> callbackOnlyOffMarket;
  final ValueChanged<bool> callbackTags;
  final ValueChanged<bool> callbackReturn;
  ...
  const FloatingSearchBar({
    ...
    required this.callbackOnlyOffMarket,
    required this.callbackDeal,
    required this.callbackFilters,
    required this.callbackTags,
    required this.callbackReturn,
    this.showVisibleFloatingFilter = false,
    this.onKeyEvent,
  })  : showAfter =
    ...
    return AnimatedAlign(
      ...
      child: transition.isBodyInsideSearchBar
          ...
          : Column(
              children: <Widget>[
                bar,
                if (isVisiblePartial == true &&
                    widget.showVisibleFloatingFilter == true)
                  _quickAccessWidget(),
                Expanded(
                  child: _buildBody(),
                ),
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            children: [
              GestureDetector(
                onTap: () {
                  widget.callbackFilters(true);
                },
                child: filterProvider.filterModel!.nCountFilter > 0
                    ? badges.Badge(
                        badgeContent: Text(
                          filterProvider.filterModel!.nCountFilter.toString(),
              ...
              GestureDetector(
                onTap: () {
                  widget.callbackDeal(true);
                },
                child: filterProvider.nCounterDeals > 0
                    ? badges.Badge(
                        badgeContent: Text(
                          filterProvider.nCounterDeals.toString(),
                          style: TextStyle(fontSize: 8, color: Colors.white),
                        ),
                        badgeStyle: badges.BadgeStyle(
                            badgeColor: headerColor,
              ...
              GestureDetector(
                onTap: () {
                  widget.callbackOnlyOffMarket(!true);
                },
                child: filterProvider.nCounterListingCategory > 0
                    ? badges.Badge(
                        badgeContent: Text(
                          filterProvider.nCounterListingCategory.toString(),
                          style: TextStyle(fontSize: 8, color: Colors.white),
                        ),
                        badgeStyle: badges.BadgeStyle(
                            badgeColor: headerColor,
              ...
              GestureDetector(
                onTap: () {
                  widget.callbackTags(!true);
                },
                child: filterProvider.nCounterTags > 0
                    ? badges.Badge(
                        badgeContent: Text(
                          filterProvider.nCounterTags.toString(),
                          style: TextStyle(fontSize: 8, color: Colors.white),
                        ),
                        badgeStyle: badges.BadgeStyle(
                            badgeColor: headerColor,
