...
import '../listing-view/listing_view.component.dart';

class PrevLot extends StatefulWidget {
  final Listing item;
  ...
  @override
  _PrevLotState createState() => _PrevLotState();
}

class _PrevLotState extends State<PrevLot> {
    ...
    try {
      widgetReturn = GestureDetector(
        onTap: () async {
          ...
          await AnalitysService().setCurrentScreen('listing_screen', 'Lot');
          Navigator.push(
            context,
            PageTransition(
