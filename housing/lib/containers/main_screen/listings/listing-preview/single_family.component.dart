...
class PrevSingleFamily extends StatefulWidget {
  final Listing item;
  ...
  @override
  _PrevSingleFamilyState createState() => _PrevSingleFamilyState();
}

class _PrevSingleFamilyState extends State<PrevSingleFamily> {
  ...
  List<dynamic> selectedList = List<dynamic>.empty(growable: true);
      ...
      widgetReturn = GestureDetector(
        onTap: () async {
          ...
          await AnalitysService()
              .setCurrentScreen('listing_screen', 'SingleFamily');
          userName == 'guess'
              ? showDialogAlertSubs(context, "Subscribe now!")
              : Navigator.push(
                  context,
                  PageTransition(
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: [
                              Text(
                                this.widget.item.nBedrooms.toString(),
                              ...
                              Text(
                                this.widget.item.nBathrooms.toString(),
                                style: const TextStyle(
                                    fontSize: 14,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold),
                              ...
                              Text(
                                formatter.format(this.widget.item.nSqft),
                                style: const TextStyle(
                                    fontSize: 14,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold),
                          ...
                          Visibility(
                            ...
                            child: Row(
                              children: [
                                Visibility(
                                    visible: this.widget.item.sLogicStatus ==
                                            'Live' &&
                                        (this
                                                    .widget
                                                    .item
  ...
  deleteDraftDialog(BuildContext context, String title, String content) {
    ...
    Widget yesButton = TextButton(
        ...
        onPressed: () {
          Navigator.pop(dialogContext!);
          deleteListing(widget.item.sSearch!, widget.item.sLogicStatus!);
        });
  ...
  showDialogAlertSubs(BuildContext context, String title) {
  ...
  ///
  /// Facebook Marketplace Post and Share
  ///
...
///
///
/// End Facebook Marketplace Post and Share
///
