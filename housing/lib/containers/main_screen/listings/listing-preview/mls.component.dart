...
class PrevMLS extends StatefulWidget {
  final Listing item;
  ...
  @override
  _PrevMLSState createState() => _PrevMLSState();
}

class _PrevMLSState extends State<PrevMLS> {
      ...
      widgetReturn = GestureDetector(
        onTap: () async {
          ...
          await AnalitysService()
              .setCurrentScreen('listing_screen', 'MLS Listing');
          Navigator.push(
            context,
            PageTransition(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // padding: EdgeInsets.only(left: 10, bottom: 10),
                                width:
                                    this.widget.item.sTypeOfSell!.length * 4 +
                                        100,
                                height: 30,
